    ...
    while (main_choice != 0)
    {
        ...
        if (main_choice == 1)
        {
            ...
            while (create_choice != 0)
            {
                ...
                cout << "Choice? ";
                cin >> create_choice;
                if (create_choice == 1) //create order
                {
                    shop.add_order();
                }
                else if (create_choice == 2) //create customer
                {
                    shop.add_customer();
                }
                ...
                else if (create_choice == 4) //create a robot model
                {
        ...
        else if (main_choice == 2) //Report Menu
        {
            int report_choice = -1;

            while(report_choice != 0)
            {
                view.show_report_menu();
                cout << "Choice? ";
                cin >> report_choice;

                if(report_choice == 4)
                {
                    view.list_robot_models(shop.robotModels);
                }
                else if(report_choice == 5)
                {
                    view.list_robot_parts(shop.robotModels);
                }
                else if (report_choice == 0)
                {
                    break;
                }
                else
                {
                    cerr << "That is not a valid choice for a report" << endl;
                }
            }
        }
    }
